...
bc.data<-read.csv("~/OneDrive - cumc.columbia.edu/2023 Columbia Spring/Machine Learning for Epi/ML_Learning_Module4/breast-cancer-wisconsin.data.txt", header=FALSE)
